...
public class BookServiceV1 {
	...
	public String searchBookName() { // 키보드에서 도서 입력받아서 리스트를 콘솔에 보이기
		...
		//		break;
				return "Q";
			searchBookName(strName);
			return strName;
	}
	
	public boolean searchBookName(String strName) { // 키보드에서 도서 입력받아서 리스트를 콘솔에 보이기
	...
	public void searchBookName(boolean bConti) { // 키보드에서 도서 입력받아서 리스트를 콘솔에 보이기
		while (true) {
			if(searchBookName() != null ) break; // 도서명을 정상적으로 입력한게 아니면 반복
		}
	}
